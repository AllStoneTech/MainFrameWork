...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            keyboard_mapper::get_keymap_layer_count,
            keyboard_mapper::get_keymap_keycode,
            keyboard_mapper::set_keymap_keycode,
            keyboard_mapper::reset_keymap,
            keyboard_mapper::get_macro_count,
            keyboard_mapper::get_macro_buffer_size,
            keyboard_mapper::get_macro_buffer,
            keyboard_mapper::set_macro_buffer,
            keyboard_mapper::reset_macros,
